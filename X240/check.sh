...
check CONFIG_TUN "y" "TUN/TAP network tunnel"
echo ""
...
check CONFIG_FAT_FS "y" "FAT (EFI)"
check CONFIG_VFAT_FS "y" "VFAT (EFI)"
check CONFIG_PROC_FS "y" "procfs"
check CONFIG_EFIVAR_FS "y" "EFI variables"
echo ""

echo "--- W. Network Features ---"
check CONFIG_TUN "y" "TUN tunnel proxy"
check CONFIG_NETFILTER "y" "Netfilter"
echo "--- IPv6 (enabled, IPv4 preferred) ---"
check CONFIG_IPV6 "y" "IPv6 (enabled but IPv4 preferred by default)"
check CONFIG_IPV6_ROUTER_PREF "y" "IPv6 router preference"
check CONFIG_IPV6_ROUTE_INFO "y" "IPv6 route info"
check CONFIG_IPV6_OPTIMISTIC_DAD "y" "IPv6 optimistic DAD"
check CONFIG_IPV6_NDISC_NODETYPE "y" "IPv6 node type"
check CONFIG_IPV6_MIP6 "y" "IPv6 Mobile IP"
check CONFIG_IPV6_SIT "m" "IPv6 SIT tunnel"
check CONFIG_IPV6_TUNNEL "m" "IPv6 tunnel"
check CONFIG_IPV6_MULTIPLE_TABLES "y" "IPv6 multiple tables"
check CONFIG_MPTCP_IPV6 "y" "MPTCP IPv6"
check CONFIG_NF_DEFRAG_IPV6 "y" "IPv6 conntrack defrag"
check CONFIG_NF_SOCKET_IPV6 "m" "IPv6 socket match"
echo ""
